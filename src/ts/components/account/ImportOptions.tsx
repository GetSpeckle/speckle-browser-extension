        ...
        <OptionSection onClick={this.chooseKeystoreOption}>
          <OptionContainer>
            <Icon viewBox='0 0 32 32'>
              <g>
                <path d='M10 30v-4h12v4h6a4 4 0 0 0 4-4V4a4 4 0 0 0-4-4H4a4 4 0 0 0-4 4v22a4 4 0 0 0 4 4h6zm-6-6V6a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v18a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z'/>
                <path d='M18 17.79l2.194 2.213a1.977 1.977 0 0 0 2.81 0l.009-.01a2 2 0 0 0 0-2.815l-4.204-4.242.007-.007-2.809-2.835-2.823 2.835.007.007-4.204 4.242a2 2 0 0 0 0 2.816l.01.01a1.977 1.977 0 0 0 2.809 0L14 17.788V34a2 2 0 1 0 4 0V17.79z'/>
              </g>
            </Icon>
            <ImportOption>
              {t('keystoreOption')}
